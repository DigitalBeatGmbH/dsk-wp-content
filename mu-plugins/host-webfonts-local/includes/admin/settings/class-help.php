            ...
            <div class="content">
                ...
                <div class="column-container">
                    <div class="column">
                        ...
                        <ul>
                            <li><a target="_blank" href="<?= apply_filters('omgf_settings_help_quick_start', ''); ?>"><i class="dashicons dashicons-controls-forward"></i><?= __('Quick Start Guide', $this->plugin_text_domain); ?></a></li>
                            <li><a target="_blank" href="<?= apply_filters('omgf_settings_help_user_manual', ''); ?>"><i class="dashicons dashicons-text-page"></i><?= __('User Manual', $this->plugin_text_domain); ?></a></li>
                            <li><a target="_blank" href="<?= apply_filters('omgf_settings_help_faq_link', ''); ?>"><i class="dashicons dashicons-editor-help"></i><?= __('FAQ', $this->plugin_text_domain); ?></a></li>
                            <li><a target="_blank" href="<?= apply_filters('omgf_settings_help_troubleshooting_link', ''); ?>"><i class="dashicons dashicons-sos"></i><?= __('Troubleshooting Guide', $this->plugin_text_domain); ?></a></li>
                            <li><a target="_blank" href="<?= apply_filters('omgf_settings_help_support_link', ''); ?>"><i class="dashicons dashicons-email"></i><?= __('Get Support', $this->plugin_text_domain); ?></a></li>
                        </ul>
                    </div>
                    <div class="column">
                    ...
                    <div class="column last">
                        ...
                        <p class="signature">
                            <a target="_blank" title="<?= __('Visit Daan.dev', $this->plugin_text_domain); ?>" href=""><img class="signature-image" alt="<?= __('Visit Daan.dev', $this->plugin_text_domain); ?>" src="<?= plugin_dir_url(OMGF_PLUGIN_FILE) . 'assets/images/logo.png'; ?>" /></a>
                        </p>
                    </div>
                </div>
            </div>
