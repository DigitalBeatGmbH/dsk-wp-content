...
if (!$controls->is_action()) {
    ...
    if ($controls->is_action('align_wp_users')) {
        ...
        foreach ($wp_user_ids as $wp_user_id) {
            ...
            $nl_user['surname'] = strval($wp_user->last_name);
...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <?php $controls->page_help('https://www.thenewsletterplugin.com/documentation/addons/extended-features/wpusers-extension/')?>
    ...
    <div id="tnp-body">
        ...
        <form method="post" action="">
            ...
            <h3><?php _e('Import already registered users', 'newsletter') ?></h3>
            <table class="form-table">   
                <tr>
            ...
            <h3><?php _e('Maintenance', 'newsletter') ?></h3>
            <table class="form-table">   
                <tr>
