    ...
    api( "woo_product_title_typography[font-family]", function( $swipe ) {
        $swipe.bind( function( pair ) {
            if ( pair ) {
                ...
                /** @type {string} */
                fontSize = "//fonts.googleapis.com" + "/css?family=" + pair + ":" + "100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i";
                if ( $( "#" + idfirst ).length ) {
        ...
        $swipe.bind( function( pair ) {
            if ( pair ) {
                /** @type {string} */
                var idfirst = ( pair.trim().toLowerCase().replace( " ", "-" ), "customizer-typography-archive-title-font-family" );
                var fontSize = pair.replace( " ", "%20" );
                fontSize = fontSize.replace( ",", "%2C" );
                /** @type {string} */
                fontSize = "//fonts.googleapis.com" + "/css?family=" + pair + ":" + "100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i";
        ...
        $swipe.bind( function( pair ) {
            if ( pair ) {
                /** @type {string} */
                var idfirst = ( pair.trim().toLowerCase().replace( " ", "-" ), "customizer-typography-archive-category-font-family" );
                var fontSize = pair.replace( " ", "%20" );
                fontSize = fontSize.replace( ",", "%2C" );
                /** @type {string} */
                fontSize = "//fonts.googleapis.com" + "/css?family=" + pair + ":" + "100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i";
            ...
            if ( pair ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-archive-category-font-family">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{font-family: ' + pair + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-category-font-weight">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{font-weight: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-category-font-style">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{font-style: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-category-font-size">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{font-size: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_category-tablet-font-size">@media (max-width: 768px){.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{font-size: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_category-mobile-font-size">@media (max-width: 480px){.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{font-size: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-category-line-height">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{line-height: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_category-tablet-line-height">@media (max-width: 768px){.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{line-height: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_category-mobile-line-height">@media (max-width: 480px){.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{line-height: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-category-letter-spacing">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{letter-spacing: ' + dataAndEvents + "px;}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_category-tablet-letter-spacing">@media (max-width: 768px){.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{letter-spacing: ' + dataAndEvents + "px;}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_category-mobile-letter-spacing">@media (max-width: 480px){.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{letter-spacing: ' + dataAndEvents + "px;}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-category-text-transform">.woocommerce ul.products li.product li.category, .woocommerce ul.products li.product li.category a{text-transform: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( pair ) {
            if ( pair ) {
                /** @type {string} */
                var idfirst = ( pair.trim().toLowerCase().replace( " ", "-" ), "customizer-typography-archive-price-font-family" );
                var fontSize = pair.replace( " ", "%20" );
                fontSize = fontSize.replace( ",", "%2C" );
                /** @type {string} */
                fontSize = "//fonts.googleapis.com" + "/css?family=" + pair + ":" + "100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i";
            ...
            if ( pair ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-archive-price-font-family">.woocommerce ul.products li.product .price{font-family: ' + pair + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-price-font-weight">.woocommerce ul.products li.product .price{font-weight: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-price-font-style">.woocommerce ul.products li.product .price{font-style: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-price-font-size">.woocommerce ul.products li.product .price{font-size: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_price-tablet-font-size">@media (max-width: 768px){.woocommerce ul.products li.product .price{font-size: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_price-mobile-font-size">@media (max-width: 480px){.woocommerce ul.products li.product .price{font-size: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-price-line-height">.woocommerce ul.products li.product .price{line-height: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_price-tablet-line-height">@media (max-width: 768px){.woocommerce ul.products li.product .price{line-height: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_price-mobile-line-height">@media (max-width: 480px){.woocommerce ul.products li.product .price{line-height: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-price-letter-spacing">.woocommerce ul.products li.product .price{letter-spacing: ' + dataAndEvents + "px;}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_price-tablet-letter-spacing">@media (max-width: 768px){.woocommerce ul.products li.product .price{letter-spacing: ' + dataAndEvents + "px;}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_archive_price-mobile-letter-spacing">@media (max-width: 480px){.woocommerce ul.products li.product .price{letter-spacing: ' + dataAndEvents + "px;}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo-archive-price-text-transform">.woocommerce ul.products li.product .price{text-transform: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( pair ) {
            if ( pair ) {
                /** @type {string} */
                var idfirst = ( pair.trim().toLowerCase().replace( " ", "-" ), "customizer-typography-single-add-to-cart-font-family" );
                var fontSize = pair.replace( " ", "%20" );
                fontSize = fontSize.replace( ",", "%2C" );
                /** @type {string} */
                fontSize = "//fonts.googleapis.com" + "/css?family=" + pair + ":" + "100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i";
            ...
            if ( pair ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-single-add-to-cart-font-family">.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{font-family: ' + pair + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-single-add-to-cart-font-weight">.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{font-weight: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-single-add-to-cart-font-style">.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{font-style: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-single-add-to-cart-font-size">.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{font-size: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_single_add_to_cart-tablet-font-size">@media (max-width: 768px){.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{font-size: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_single_add_to_cart-mobile-font-size">@media (max-width: 480px){.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{font-size: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-single-add-to-cart-line-height">.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{line-height: ' + dataAndEvents + ";}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_single_add_to_cart-tablet-line-height">@media (max-width: 768px){.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{line-height: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-woo_single_add_to_cart-mobile-line-height">@media (max-width: 480px){.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{line-height: ' + dataAndEvents + ";}}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
        ...
        $swipe.bind( function( dataAndEvents ) {
            ...
            if ( dataAndEvents ) {
                /** @type {string} */
                var img = '<style class="customizer-typography-single-add-to-cart-letter-spacing">.woocommerce .owp-btn-normal .summary form button.button, .woocommerce .owp-btn-big .summary form button.button, .woocommerce .owp-btn-very-big .summary form button.button{letter-spacing: ' + dataAndEvents + "px;}</style>";
                if ( $child.length ) {
                    $child.replaceWith( img );
                } else {
                    $( "head" ).append( img );
